...
import { drawImage, drawLeftImage } from "./helpers/showImagesPowerTowerInspection";
import noImage from "../../assets/img/noImage.png";

import "./css/GUICanvas.css"
function SpecificPowerTowerInspection(props) {
  React.useEffect(() => {
...
SpecificPowerTowerInspection.propTypes = {
  circuit: PropTypes.string,
};

export default SpecificPowerTowerInspection;
